...
public class WebEvenListener  implements WebDriverEventListener      //extended Abstract class and interface 
{
	
	public static final Logger log = Logger.getLogger(WebEvenListener.class.getName());
